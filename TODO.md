...
- Social : Clic sur un profil : select_001.ogg
- LevelUp : couper tous les autres bruitages
- ToastManager : un toast s'en va : retirer le bruit
> Mini jeu de minage
- Minage (basique) : scratch_004.ogg
- Minage (explosion) : select_004.ogg
- Affichage du bouton continuer : pluck_002.ogg
...
Social : Afficher le niveau du joueur sur les leaderboards sur leur avatar comme sur TopBar
Mode difficile